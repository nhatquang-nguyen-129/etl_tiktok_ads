...
def load_campaign_insights(
    *,
    ...
    """
    Load TikTok Ads campaign insights
    ---
    Principles:
    ...
    if df.empty:
        ...
        print(
            "⚠️ [LOADER] Empty TikTok Ads campaign insights then loading will be suspended."
        )
        
        return

    print(
        "🔄 [LOADER] Triggering to load TikTok Ads campaign insights with "
